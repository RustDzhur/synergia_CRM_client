...
// Подключение внешнего сервиса (Twilio, Telegram, Viber, Messenger, онлайн-чат, почтовый ящик).
...
const IntegrationSchema = new Schema(
    {
        ...
        type: { type: String, required: true, enum: ["twilio", "telegram", "viber", "messenger", "webchat", "mail"] },

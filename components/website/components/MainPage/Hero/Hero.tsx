...
export default function Hero() {
	...
	return (
		<div className="md:text-center lg:flex lg:justify-between lg:items-start sm:pb-20 md:pb-[28px] lg:pb-[160px]">
			<div className="lg:w-610 lg:text-left">
				<h1 className="sm:text-32 lg:text-50 font-semibold text-discover sm:leading-[175%] lg:leading-[87px] tracking-[0.64px] lg:tracking-[1.1px] sm:mb-8 lg:mb-[-3px] md:text-center lg:text-left">
				...
				<button className="sm:w-full md:w-auto bg-authBtn text-center sm:px-30 sm:py-15 md:px-40 lg:px-[30px] md:py-[12px] md:leading-[28px] text-white text-18 font-medium lg:tracking-[0.5px] sm:mb-50">
					{t('plan')}
				</button>
			</div>

			<div className="flex justify-center lg:-mr-[8px]">

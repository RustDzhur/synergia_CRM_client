...
export default function JoinUs() {
	...
	return (
		<div>
			...
			<div className="bg-joinUsPink sm:px-12 sm:pt-30 sm:pb-[26px] md:px-[4px] md:pt-20 md:pb-[20px] lg:px-100 lg:pt-50 lg:pb-40 text-white md:grid md:grid-cols-3 md:gap-x-0 lg:gap-x-80 sm:space-y-40 md:space-y-0">
				{contents.map((content, index) => (
					<div key={index} className="flex flex-col items-center text-center md:px-[20px] lg:px-0">

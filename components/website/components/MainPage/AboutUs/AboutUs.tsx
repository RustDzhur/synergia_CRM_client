		...
		<div className="md:relative">
			<div className="md:absolute sm:px-12 sm:py-40 sm:text-center md:bottom-0 md:right-0 md:p-20 md:pt-[17px] md:h-[204px] lg:h-[300px] md:text-left md:bg-aboutUsBackground md:rounded-t-10 md:rounded-br-10 md:w-[392px] lg:w-[590px] lg:rounded-16 lg:px-35 lg:pt-[30px] lg:pb-0">
				<div className="md:w-full">
					...
					<h3 className="text-white sm:text-24 sm:tracking-[0.48px] sm:leading-[140%] sm:mb-[23px] md:text-[26px] md:leading-[35px] md:mb-[22px] md:tracking-[0.52px] font-medium lg:text-36 lg:leading-[48px] lg:tracking-[1px] lg:mb-[26px]">
						{t('description')}
					</h3>
					<div className="sm:mb-[11px] lg:mb-0">
						<LinkAboutUs />
					</div>
				</div>
			</div>
